...
const getCurrentDate = function () {
  const timer = function () {
    ...
    //const time_Formatted = date_Time.format("hh:mm:ss a "); // added additional variable-not used yet
    dateText.text(dateTime_Formatted);
    //timeText.text(time_Formatted);//not used yet
  };
  timer();
...
//const dateTimeFormatted = dateTime.format("dddd, MMMM Do YYYY");

//const dateTimeFormatted = dateTime.format("hh:mm:ss a ");
///};
///timerTick();
